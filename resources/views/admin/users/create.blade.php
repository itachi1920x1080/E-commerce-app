        ...
        <div class="p-6 bg-white">
            ...
            @if ($errors->any())
                <div class="mb-6 p-4 bg-red-50 border border-red-200 text-red-800 rounded-lg text-sm font-medium shadow-sm">
                    <strong class="block font-bold text-red-900 mb-1.5">⚠️ មិនអាចបង្កើតគណនីបានទេ៖</strong>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4 mt-2">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="active" value="1" class="text-indigo-600 focus:ring-indigo-500" {{ old('active', '1') == '1' ? 'checked' : '' }}>
                                    <span class="ml-2 text-sm text-gray-700">Active</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="active" value="0" class="text-indigo-600 focus:ring-indigo-500" {{ old('active') == '0' ? 'checked' : '' }}>
